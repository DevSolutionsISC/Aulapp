...
Route::middleware(['auth'])->group(function () {
 ...
 Route::get('/seccion', [SeccionController::class, 'index'])->name('secciones');
 Route::post('/seccion', [SeccionController::class, 'store'])->name('secciones');
 ...
 Route::get('/seccionEdit', [SeccionController::class, 'showEdit'])->name('seccion_edit');
 Route::get('/seccion/{id}', [SeccionController::class, 'update'])->name('seccion-update');
