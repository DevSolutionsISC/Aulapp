...
class reservaController extends Controller
{
  ...
  public function respuesta(Request $request, $id, $estado)
  {
    ...
    if ($estado == 0) {
      ...
      $rechazado->save();
      Notification::route('mail', $rechazado->user_rol->usuario->Email)->notify(new NotificacionReserva($rechazado));
      ...
      Notification::route('mail', $aceptado->user_rol->usuario->Email)->notify(new NotificacionReserva($aceptado, $aulas_asignadas));
